...
The full contributor/agent guide for this repository lives in [`CLAUDE.md`](CLAUDE.md) — read it first for
architecture, the SPI seams, build/test commands, and conventions.
